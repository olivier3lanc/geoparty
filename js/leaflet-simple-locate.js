...
(function (factory) {
    ...
    const SimpleLocate = L.Control.extend({
         ...
         * @property {Function} [afterUnwatchOrientation] - Callback after unwatching orientation.
         * @property {Function} [afterUnwatchGeolocation] - Callback after unwatching geolocation.
         */
        options: {
            className: "",
            ...
            afterUnwatchOrientation: null,
            afterUnwatchGeolocation: null,
...
<svg width="96" height="96" viewBox="-48 -48 96 96" xmlns="http://www.w3.org/2000/svg">
	...
	<g id="leaflet-simple-locate-icon-spot">
        ...
        _unwatchGeolocation: function () {
            if (this.options.afterUnwatchGeolocation) this.options.afterUnwatchGeolocation();
        ...
        _unwatchOrientation: function () {
            if (this.options.afterUnwatchOrientation) this.options.afterUnwatchOrientation();
